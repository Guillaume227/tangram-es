...
struct TileID {
    ...
    TileID(int32_t _x, int32_t _y, int32_t _z, int32_t _s, int32_t _wrap) : x(_x), y(_y), z(static_cast<int8_t>(_z)), s(static_cast<int8_t>(_s)), wrap(static_cast<int16_t>(_wrap)) {}
